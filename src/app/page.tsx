            ...
            <div className={styles.dialogBox}>
              ...
              {showExamineeContent && (
                <div className={`${styles.npcNoticeInline} ${hasSubmittedThisMonth && !hasEssayLock ? styles.noticeSuccess : ''}`}>
                  ...
                  <span className={styles.noticeContentInline}>
                  ...
                  <button
                    className={`btn-pixel btn-secondary ${styles.npcNoticeBtn}`}
                    onClick={() => router.push('/exam/essay/lobby')}
                  >
                    {hasEssayLock ? '查看進度' : hasSubmittedThisMonth ? '檢視紀錄' : '前往申論考場'}
                  </button>
                </div>
              )}
            </div>
